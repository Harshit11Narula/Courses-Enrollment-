...
def courses(term="8"):
       ...
       return render_template("courses.html", courseData = classes, course=True, term = term)
...
def register():
    ...
    if form.validate_on_submit():
        ...
        user.save()
        flash("You are sucessfully Register", "sucess")
        return redirect(url_for('index'))
...
def enrollment():
    ...
    if courseID:
        if Enrollment.objects(user_id=user_id, courseID=courseID):
            ...
            flash(f"You are enrolled successfully in {courseTitle}!", "success")
...
@app.route("/user")
def user():
    # User(user_id=1, first_name="Harshit", last_name="Narul", email="harshit@gmail.com", password="1234").save()
